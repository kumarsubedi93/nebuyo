<div class="col-xl-9 col-wd-9gdot5">
    ...
    <div class="flex-center-between mb-3">
        <h3 class="font-size-25 mb-0">{{ translate('customer product') }} </h3>
    </div>
    ...
    <div class="bg-gray-1 flex-center-between borders-radius-9 py-1">
        ...
        <div class="d-flex">
            ...
            <form method="get" class="ml-2 d-none d-xl-block">
                <!-- Select -->
                <select id="condition" class="js-select btn_filter_form selectpicker dropdown-select max-width-200"
                        data-style="btn-sm bg-white font-weight-normal py-2 border text-gray-20 bg-lg-down-transparent border-lg-down-0">
    ...
    <div class="tab-content-search-box tab-content-search-box-custom">
        @include('newui.home.partials.search.customer-search-result', ['products' => $products])
    </div>
</div>
