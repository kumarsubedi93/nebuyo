                ...
                <div class="my-md-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-3 flex-nowrap flex-xl-wrap overflow-auto overflow-xl-visble">
                            ...
                            <li class="breadcrumb-item flex-shrink-0 flex-xl-shrink-1"><a href="{{ route('new.categories.second', ['category' => $category->slug, 'subCategory' => $sub_category->slug]) }}">{{ $sub_category->name }}</a></li>
                            <li class="breadcrumb-item flex-shrink-0 flex-xl-shrink-1 active" aria-current="page">{{ $sub_sub_category->name }}</li>
                        </ol>
                    </nav>
                </div>
                <!-- End breadcrumb -->
                ...
                <div class="d-none d-xl-block col-xl-3 col-wd-2gdot5">
                    <div class="mb-8 border border-width-2 border-color-3 borders-radius-6">
                        ...
                        <ul id="sidebarNav" class="list-unstyled mb-0 sidebar-navbar">
                            ...
                            <li>
                                <a class="dropdown-current active" href="shop-grid.html#">{{ $sub_sub_category->name }} </a>
                    ...
                    <div class="mb-6">
                        <form class="" id="search-form" action="{{ route('new.search.category') }}" method="GET">
                            @php
                                $num = Crypt::encryptString($sub_sub_category->id);
                            @endphp
                            <input type="text" value="{{ $query??'' }}" name="q" hidden>
                            <input type="text" value="{{ $num }}" name="subsubcategory" hidden>
...
{{--                        </div>--}}
                        ...
                        @foreach ($attributes as $key => $attribute)
                            ...
                            <div class="range-slider">
                                ...
                                <button class="btn px-4 btn-primary-dark-w py-2 rounded-lg" onclick="categoryFilter()">Filter</button>
                            </div>
                        </form>
                    </div>
                                ...
                                <div class="row">
                                    <div class="col-auto">
                                        <a href="single-product-fullwidth.html" class="d-block width-75">
                                            <img class="img-fluid" src="{{ static_asset('newui/assets/img/300X300/img1.jpg') }}" alt="Image Description">
                                        </a>
                                    </div>
                                    <div class="col">
                ...
                <div class="col-xl-9 col-wd-9gdot5">
                    ...
                    <div class="d-block d-md-flex flex-center-between mb-3">
                        <h3 class="font-size-25 mb-2 mb-md-0">{{ $sub_sub_category->name }}</h3>
                    ...
                    <div class="bg-gray-1 flex-center-between borders-radius-9 py-1">
                        ...
                        <div class="px-3 d-none d-xl-block">
                            <ul class="nav nav-tab-shop" id="pills-tab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="pills-one-example1-tab" data-toggle="pill" href="shop-grid.html#pills-one-example1" role="tab" aria-controls="pills-one-example1" aria-selected="false">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="pills-two-example1-tab" data-toggle="pill" href="shop-grid.html#pills-two-example1" role="tab" aria-controls="pills-two-example1" aria-selected="false">
                                        <div class="d-md-flex justify-content-md-center align-items-md-center">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="pills-three-example1-tab" data-toggle="pill" href="shop-grid.html#pills-three-example1" role="tab" aria-controls="pills-three-example1" aria-selected="true">
                                        <div class="d-md-flex justify-content-md-center align-items-md-center">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="pills-four-example1-tab" data-toggle="pill" href="shop-grid.html#pills-four-example1" role="tab" aria-controls="pills-four-example1" aria-selected="true">
                                        <div class="d-md-flex justify-content-md-center align-items-md-center">
                        ...
                        <nav class="px-3 flex-horizontal-center text-gray-20 d-none d-xl-flex">
                            ...
                            <a class="text-gray-30 font-size-20 ml-2" href="shop-grid.html#">→</a>
                        </nav>
                    </div>
...
{{--                                            @include('newui.common.product-item', ['product' => $product])--}}
                                            ...
                                            <div class="product-item__outer h-100">
                                                <div class="product-item__inner px-xl-4 p-3">
                                                    <div class="product-item__body pb-xl-2">
                                                        <div class="mb-2">
                                                            <a href="{{ route('new.categories.product_list', ['category' => $category->slug, 'subCategory' => $sub_category->slug, 'subSubCategory' => $sub_sub_category->slug]) }}" class="font-size-12 text-gray-5">{{ $sub_sub_category->name }}</a>
                                                        </div>
                                                        <h5 class="mb-1 product-item__title">
                                                            <a href="{{ route('new.product', ['slug' => $product->slug]) }}" class="text-blue font-weight-bold">{{ $product->name }}</a>
                                                        </h5>
                                                        <div class="mb-2">
                                                            <a href="{{ route('new.product', ['slug' => $product->slug]) }}" class="d-block text-center">
                                                                <img class="img-fluid" src="{{ my_asset($product->thumbnail_img) }}" alt="Image Description">
                                                            </a>
                                                        </div>
                                    ...
                                    <div class="product-item__outer h-100">
                                        <div class="product-item__inner px-xl-4 p-3">
                                            <div class="product-item__body pb-xl-2">
                                                ...
                                                <div class="mb-3">
                                                    <a class="d-inline-flex align-items-center small font-size-14" href="shop-grid.html#">
                                            ...
                                            <div class="product-item__header col-6 col-md-2">
                                                <div class="mb-2">
                                                    <a href="single-product-fullwidth.html" class="d-block text-center">
                                                        <img class="img-fluid" src="assets/img/212X200/img9.jpg" alt="Image Description"></a>
                                                </div>
                                            </div>
                    ...
                    <nav class="d-md-flex justify-content-between align-items-center border-top pt-3" aria-label="Page navigation example">
                        ...
                        <ul class="pagination mb-0 pagination-shop justify-content-center justify-content-md-start">
                            <li class="page-item"><a class="page-link current" href="shop-grid.html#">1</a></li>
                            <li class="page-item"><a class="page-link" href="shop-grid.html#">2</a></li>
                            <li class="page-item"><a class="page-link" href="shop-grid.html#">3</a></li>
                        </ul>
                    </nav>
                    <!-- End Shop Pagination -->
                </div>
            ...
            <div class="mb-6">
                <div class="py-2 border-top border-bottom">
                    <div class="js-slick-carousel u-slick my-1"
                        ...
                        <div class="js-slide">
                            <a href="shop-grid.html#" class="link-hover__brand">
...
@push('script')
    <script>
        ...
        function categoryFilter(){
            findDataForSubSubCategoryFilter();
            // console.log(findDataForSubSubCategoryFilter);
            // $('#search-form').submit();
        }

        function findDataForSubSubCategoryFilter(){
            ...
            if(priceRange){
                ...
                $('#min_price').val($.trim(price[0]));
                $('#max_price').val($.trim(price[1]));
            }
            $('#sort_by').val(sortId);
            $('#brand').val(brandName);
