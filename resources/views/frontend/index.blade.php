                        ...
                        <ul class="categories no-scrollbar">
                            ...
                            @foreach (\App\Category::all()->take(11) as $key => $category)
                                ...
                                <li class="category-nav-element" data-id="{{ $category->id }}">
                                    <section_featureda href="{{ route('products.category', $category->slug) }}" class="text-truncate">
                    ...
                    <div class="flash-deal-box bg-white h-100">
                        ...
                        <div class="flash-content c-scrollbar c-height">
                            @foreach (filter_products(\App\Product::where('published', 1)->where('todays_deal', '1'))->get() as $key => $product)
                                @if ($product != null)
                                    <a href="{{ route('new.product', $product->slug) }}" class="d-block flash-deal-item">
                                ...
                                <div class="product-card-2 card card-product shop-cards">
                                    <div class="card-body p-0">
                                        <div class="card-image">
                                            <a href="{{ route('new.product', $product->slug) }}" class="d-block">
                                        ...
                                        <div class="p-md-3 p-2">
                                            ...
                                            <h2 class="product-title p-0">
                                                <a href="{{ route('new.product', $product->slug) }}" class=" text-truncate">{{ __($product->name) }}</a>
                                            </h2>
