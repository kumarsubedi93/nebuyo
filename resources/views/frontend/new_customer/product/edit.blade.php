...
@section('content')
    <div class="container-fluid">
        ...
        @include('newui.customer.layouts.breadcrumb',
                    ['panel' => 'Product Edit'],
                    ['lists' => [
                        route('new.seller.products') => 'product',
                        '#' => $product->name,
                        ],
              ])

        <div class="panel panel-default card-view" id="page-content">
            <form class="" action="{{route('new.products.update', $product->id)}}" method="POST"
                ...
                <div class="form-box bg-white mt-4">
                    ...
                    <div class="form-box-content p-3">
                        <div class="row mb-10">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control mb-3" name="name"
                                       placeholder="{{ translate('Product Name')}}" value="{{  __($product->name) }}">
                            </div>
                        </div>
                        <div class="row mb-10">
                            <div class="col-md-2">
                            ...
                            <div class="col-md-10">
                                @if ($product->subsubcategory != null)
                                    <div class="form-control mb-3 c-pointer" data-toggle="modal"
                                         ...
                                         id="product_category">{{ $product->category->name.'>'.$product->subcategory->name.'>'.$product->subsubcategory->name }}</div>
                                @else
                                    <div class="form-control mb-3 c-pointer" data-toggle="modal"
                                         data-target="#categorySelectModal"
                                         id="product_category">{{ $product->category->name.'>'.$product->subcategory->name }}</div>
                                @endif
                        ...
                        <div class="row mb-10">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control mb-3" name="unit"
                                       placeholder="{{ translate('Product unit') }}" value="{{ $product->unit }}">
                            </div>
                        </div>
                        ...
                        <div class="row mb-10">
                            ...
                            <div class="col-md-10">
                                <input type="number" class="form-control mb-3" name="min_qty" min="1"
                        ...
                        <div class="row mb-10">
                            ...
                            <div class="col-md-10">
                                <input type="file" name="thumbnail_img"
                                       class="dropify"
                                       @if(isset($product->thumbnail_img)) data-default-file="{{ my_asset($product->thumbnail_img) }}" @endif />
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row mb-10">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control mb-3" name="video_link"
                                       placeholder="{{ translate('Video link')}}" value="{{ $product->video_link }}">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="form-box-content p-3">
                        ...
                        <div class="row mb-10">
                            ...
                            <textarea name="meta_description" rows="8"
                                      class="form-control mb-3">{{ $product->meta_description }}</textarea>
                            </div>
                        </div>
                        <div class="row mb-10">
                            <div class="col-md-2">
                            ...
                            <div class="col-md-10">
                                ...
                                <input type="file" name="meta_img" id="file-5" accept="image/*"
                                       class="dropify"
                                       @if(isset($product->meta_img)) data-default-file="{{ my_asset($product->meta_img) }}" @endif />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="form-box-content p-3">
                        <div class="row mb-10">
                            ...
                            <div class="col-12 col-md-7 col-xl-8 order-3 order-md-0 mt-2 mt-md-0">
                                @php $colors = \App\Color::orderBy('name', 'asc')->get() @endphp
                                <select class="form-control color-var-select" multiple name="colors[]" id="colors"
                                        multiple>
                                    @if($colors->isNotEmpty())
                                        @foreach ($colors as $key => $color)
                                            <option
                                                value="{{ $color->code }}" {{ in_array($color->code, json_decode($product->colors)) ? 'selected' : '' }}>{{ $color->name }}</option>
                                        @endforeach
                                    @endif
                                </select>
                            </div>
                            ...
                            <div class="col-md-7">
                                <div class="">
                                    <select name="choice_attributes[]" id="choice_attributes"
                                            class="form-control selectpicker multiple-attributes" multiple
                ...
                <div class="form-box bg-white mt-4">
                    ...
                    <div class="form-box-content p-3">
                        <div class="row mb-10">
                            ...
                            <div class="col-md-10">
                                <input type="number" min="0" step="0.01" class="form-control mb-3" name="unit_price"
                        ...
                        <div class="row mb-10">
                            ...
                            <div class="col-md-10">
                                <input type="number" min="0" step="0.01" class="form-control mb-3" name="purchase_price"
                        ...
                        <div class="row" id="quantity">
                            ...
                            <div class="col-md-10">
                                <input type="number" step="1" class="form-control mb-3" name="current_stock"
                                       placeholder="{{ translate('Quantity')}}" value="{{$product->current_stock}}">
                            </div>
                        </div>
                        <div class="row mb-10">
                            ...
                            <div class="row mb-10">
                                ...
                                <div class="col-md-8">
                                    <input type="number" min="0" step="0.01" class="form-control mb-3"
                                           name="flat_shipping_cost" value="{{ $product->shipping_cost }}"
                ...
                <div class="form-box bg-white mt-4">
                    ...
                    <div class="form-box-content p-3 mt-10">
                        <div class="row mb-10">
                            ...
                            <div class="col-md-10">
                                <div class="mb-3">
                                    <textarea class="form-control editor" name="description" rows="8">
                                        {{$product->description}}
                                    </textarea>
                                </div>
                            </div>
                ...
                <div class="form-box bg-white mt-4">
                    ...
                    <div class="form-box-content p-3 mt-10">
                        <div class="row mb-10">
                            ...
                            <div class="col-md-10">
                                <div class="mb-3">
                                    <textarea class="form-control editor" name="short_description" rows="8">
                                        {{  optional($product)->short_description }}
                                    </textarea>
                                </div>
                            </div>
                        </div>
...
@push('js')
    ...
    <script type="text/javascript">
        ...
        function add_more_slider_image() {
            ...
            photoAdd += '<input type="file" name="photos[]" id="photos-' + photo_id + '" class="temp-dropify" data-multiple-caption="{count} files selected" multiple accept="image/*" />';
