    ...
    <div class="container-fluid">
        ...
        <div class="panel">
            <div class="panel-body">
                ...
                <br>
                <div class="">
                    <a href="{{ route('new.pdf.download_category') }}"><button class="btn btn-primary">{{translate('Download Category')}}</button></a>
                    <a href="{{ route('new.pdf.download_sub_category') }}"><button class="btn btn-primary">{{translate('Download Sub category')}}</button></a>
                    <a href="{{ route('new.pdf.download_sub_sub_category') }}"><button class="btn btn-primary">{{translate('Download Sub Sub category')}}</button></a>
                    <a href="{{ route('new.pdf.download_brand') }}"><button class="btn btn-primary">{{translate('Download Brand')}}</button></a>
                </div>
                <br>
            </div>
        </div>
        ...
        <div class="panel">
            ...
            <div class="panel-body">
                <form class="form-horizontal" action="{{ route('new.bulk_product_upload') }}" method="POST" enctype="multipart/form-data">
                    @csrf
