...
@section('content')
    ...
    <section class="product-details-area">
        <div class="container">
            ...
            <div class="bg-white">
               @php
                  $product_photos =  json_decode($customer_product->photos, true);
               @endphp
                    ...
                    <div class="col-lg-6">
                        <div class="product-gal sticky-top d-flex flex-row-reverse">
                            <div class="product-gal-img">
                                <img class="xzoom img-fluid" src="{{ my_asset(json_decode($customer_product->photos)[0]) }}"
                                     xoriginal="{{ my_asset(json_decode($customer_product->photos)[0]) }}" />
                            </div>
                                ...
                                <div class="xzoom-thumbs">
                                    ...
                                    @foreach (explode(',', $customer_product->photos) as $key => $photo)
                                        <a href="{{ uploaded_asset($photo) }}">
                                            <img class="xzoom-gallery" width="80" src="{{ uploaded_asset($photo) }}"  @if($key == 0) xpreview="{{ my_asset($photo) }}" @endif>
                                        </a>
                                    @endforeach
                                    @endif
                                </div>
