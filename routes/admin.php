...
Route::group(['prefix' =>'admin', 'middleware' => ['auth', 'admin']], function(){
    ...
    Route::get('get-specification', 'CategoryController@getSpecification')->name('getSpecification');
	...
	Route::get('/frontend_settings/menu', 'HomeController@menu_settings')->name('menu_settings.index');
    Route::post('/frontend_settings/menu/update', 'HomeController@menu_settings_ajax_update')->name('menu_settings.ajax_update');
    Route::post('/frontend_settings/menu/update-status', 'HomeController@menu_settings_ajax_update_status')->name('menu_settings.ajax_update_status');
	...
	Route::group(['prefix' => 'frontend_settings'], function(){
	    ...
	    Route::post('/sliders/update_publish/{id}', 'SliderController@updatePublish')->name('sliders.update_publish');
    ...
    Route::post('/products/popular_category', 'ProductController@updatePopularCategory')->name('products.popular_category');
