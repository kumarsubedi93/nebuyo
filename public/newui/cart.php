							...
							<tbody>
								<tr class="">
									...
									<td class="d-none d-md-table-cell">
										<a href="cart.html#"><img class="img-fluid max-width-100 p-1 border border-color-1" src="assets/img/300X300/img6.jpg" alt="Image Description"></a>
									</td>

									<td data-title="Product">
										<a href="cart.html#" class="text-gray-90">Ultra Wireless S50 Headphones S50 with Bluetooth</a>
									</td>
								...
								<tr class="">
									...
									<td class="d-none d-md-table-cell">
										<a href="cart.html#"><img class="img-fluid max-width-100 p-1 border border-color-1" src="assets/img/300X300/img7.png" alt="Image Description"></a>
									</td>

									<td data-title="Product">
										<a href="cart.html#" class="text-gray-90">Widescreen NX Mini F1 SMART NX</a>
									</td>
								...
								<tbody>
									...
									<tr class="shipping">
										...
										<td data-title="Shipping">
											...
											<div class="mt-1">
												<a class="font-size-12 text-gray-90 text-decoration-on underline-on-hover font-weight-bold mb-3 d-inline-block" data-toggle="collapse" href="cart.html#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">
													Calculate Shipping
												</a>
