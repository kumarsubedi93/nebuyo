								...
								<li>
									...
									<div id="sidebarNav1Collapse" class="collapse" data-parent="#sidebarNav">
										<ul id="sidebarNav1" class="list-unstyled dropdown-list">
											<!-- Menu List -->
											<li><a class="dropdown-item" href="single-product-sidebar.html#">Accessories<span class="text-gray-25 font-size-12 font-weight-normal"> (56)</span></a></li>
											<li><a class="dropdown-item" href="single-product-sidebar.html#">Cameras & Photography<span class="text-gray-25 font-size-12 font-weight-normal"> (11)</span></a></li>
											<li><a class="dropdown-item" href="single-product-sidebar.html#">Computer Components<span class="text-gray-25 font-size-12 font-weight-normal"> (22)</span></a></li>
											<li><a class="dropdown-item" href="single-product-sidebar.html#">Gadgets<span class="text-gray-25 font-size-12 font-weight-normal"> (5)</span></a></li>
											<li><a class="dropdown-item" href="single-product-sidebar.html#">Home Entertainment<span class="text-gray-25 font-size-12 font-weight-normal"> (7)</span></a></li>
											<li><a class="dropdown-item" href="single-product-sidebar.html#">Laptops & Computers<span class="text-gray-25 font-size-12 font-weight-normal"> (42)</span></a></li>
											<li><a class="dropdown-item" href="single-product-sidebar.html#">Printers & Ink<span class="text-gray-25 font-size-12 font-weight-normal"> (63)</span></a></li>
											<li><a class="dropdown-item" href="single-product-sidebar.html#">Smart Phones & Tablets<span class="text-gray-25 font-size-12 font-weight-normal"> (11)</span></a></li>
											<li><a class="dropdown-item" href="single-product-sidebar.html#">TV & Audio<span class="text-gray-25 font-size-12 font-weight-normal"> (66)</span></a></li>
											<li><a class="dropdown-item" href="single-product-sidebar.html#">Video Games & Consoles<span class="text-gray-25 font-size-12 font-weight-normal"> (31)</span></a></li>
											<!-- End Menu List -->
										</ul>
									</div>
								</li>
								<li>
									<a class="dropdown-current" href="single-product-sidebar.html#">Accessories</a>

									<ul class="list-unstyled dropdown-list">
										<!-- Menu List -->
										<li><a class="dropdown-item" href="single-product-sidebar.html#">Cases<span class="text-gray-25 font-size-12 font-weight-normal"> (56)</span></a></li>
										<li><a class="dropdown-item" href="single-product-sidebar.html#">Chargers<span class="text-gray-25 font-size-12 font-weight-normal"> (51)</span></a></li>
										<li><a class="dropdown-item" href="single-product-sidebar.html#">Headphone Cases<span class="text-gray-25 font-size-12 font-weight-normal"> (44)</span></a></li>
										<li><a class="dropdown-item active" href="single-product-sidebar.html#">Headphones<span class="text-gray-25 font-size-12 font-weight-normal"> (89)</span></a></li>
										<li><a class="dropdown-item" href="single-product-sidebar.html#">Headphone Accessories<span class="text-gray-25 font-size-12 font-weight-normal"> (4)</span></a></li>
										<li><a class="dropdown-item" href="single-product-sidebar.html#">Pendrives<span class="text-gray-25 font-size-12 font-weight-normal"> (14)</span></a></li>
										<li><a class="dropdown-item" href="single-product-sidebar.html#">Power Banks<span class="text-gray-25 font-size-12 font-weight-normal"> (61)</span></a></li>
										<!-- End Menu List -->
									</ul>
								</li>
							</ul>
								...
								<div class="col-md-7 mb-md-6 mb-lg-0">
									<div class="mb-2">
										<div class="border-bottom mb-3 pb-md-1 pb-3">
											<a href="single-product-sidebar.html#" class="font-size-12 text-gray-5 mb-2 d-inline-block">Headphones</a>
											<h2 class="font-size-25 text-lh-1dot2">Ultra Wireless S50 Headphones S50 with Bluetooth</h2>
											<div class="mb-2">
												<a class="d-inline-flex align-items-center small font-size-15 text-lh-1" href="single-product-sidebar.html#">
											...
											<div class="d-md-flex align-items-center">
												<a href="single-product-sidebar.html#" class="max-width-150 ml-n2 mb-2 mb-md-0 d-block"><img class="img-fluid" src="assets/img/200X60/img1.png" alt="Image Description"></a>
										...
										<div class="flex-horizontal-center flex-wrap mb-4">
											<a href="single-product-sidebar.html#" class="text-gray-6 font-size-13 mr-2"><i class="ec ec-favorites mr-1 font-size-15"></i> Wishlist</a>
											<a href="single-product-sidebar.html#" class="text-gray-6 font-size-13 ml-2"><i class="ec ec-compare mr-1 font-size-15"></i> Compare</a>
										</div>
										<div class="mb-2">
										...
										<div class="d-md-flex align-items-end mb-3">
											...
											<div class="ml-md-3">
												<a href="single-product-sidebar.html#" class="btn px-5 btn-primary-dark transition-3d-hover"><i class="ec ec-add-to-cart mr-2 font-size-20"></i> Add to Cart</a>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="position-relative mx-md-6">
								<ul class="nav nav-classic nav-tab nav-tab-lg justify-content-xl-center flex-nowrap flex-xl-wrap overflow-auto overflow-xl-visble border-0 pb-1 pb-xl-0 mb-n1 mb-xl-0" id="pills-tab-8" role="tablist">
									<li class="nav-item flex-shrink-0 flex-xl-shrink-1 z-index-2">
										<a class="nav-link active" id="Jpills-one-example1-tab" data-toggle="pill" href="single-product-sidebar.html#Jpills-one-example1" role="tab" aria-controls="Jpills-one-example1" aria-selected="true">Accessories</a>
									</li>
									<li class="nav-item flex-shrink-0 flex-xl-shrink-1 z-index-2">
										<a class="nav-link" id="Jpills-two-example1-tab" data-toggle="pill" href="single-product-sidebar.html#Jpills-two-example1" role="tab" aria-controls="Jpills-two-example1" aria-selected="false">Description</a>
									</li>
									<li class="nav-item flex-shrink-0 flex-xl-shrink-1 z-index-2">
										<a class="nav-link" id="Jpills-three-example1-tab" data-toggle="pill" href="single-product-sidebar.html#Jpills-three-example1" role="tab" aria-controls="Jpills-three-example1" aria-selected="false">Specification</a>
									</li>
									<li class="nav-item flex-shrink-0 flex-xl-shrink-1 z-index-2">
										<a class="nav-link" id="Jpills-four-example1-tab" data-toggle="pill" href="single-product-sidebar.html#Jpills-four-example1" role="tab" aria-controls="Jpills-four-example1" aria-selected="false">Reviews</a>
									</li>
								</ul>
							</div>
							<!-- Tab Content -->
								...
								<div class="tab-content" id="Jpills-tabContent">
										...
										<div class="row no-gutters">
														...
														<div class="product-item__outer h-100">
															<div class="remove-prodcut-hover product-item__inner px-xl-4 p-3">
																<div class="product-item__body pb-xl-2">
																	...
																	<h5 class="mb-1 product-item__title d-none d-md-block"><a href="single-product-sidebar.html#" class="text-blue font-weight-bold">Wireless Audio System Multiroom 360 degree Full base audio</a></h5>
																	<div class="mb-2">
													...
													<li class="col-4 col-md-4 col-xl-2gdot5 product-item remove-divider-sm-down">
														<div class="product-item__outer h-100">
															<div class="remove-prodcut-hover add-accessories product-item__inner px-xl-4 p-3">
																<div class="product-item__body pb-xl-2">
																	<div class="mb-2 d-none d-md-block"><a href="product-categories-7-column-full-width.html" class="font-size-12 text-gray-5">Speakers</a></div>
																	<h5 class="mb-1 product-item__title d-none d-md-block"><a href="single-product-sidebar.html#" class="text-blue font-weight-bold">Tablet White EliteBook Revolve 810 G2</a></h5>
																	<div class="mb-2">
													...
													<li class="col-4 col-md-4 col-xl-2gdot5 product-item remove-divider-sm-down remove-divider">
														<div class="product-item__outer h-100">
															<div class="remove-prodcut-hover add-accessories product-item__inner px-xl-4 p-3">
																<div class="product-item__body pb-xl-2">
																	<div class="mb-2 d-none d-md-block"><a href="product-categories-7-column-full-width.html" class="font-size-12 text-gray-5">Speakers</a></div>
																	<h5 class="mb-1 product-item__title d-none d-md-block"><a href="single-product-sidebar.html#" class="text-blue font-weight-bold">Purple Solo 2 Wireless</a></h5>
																	<div class="mb-2">
											...
											<div class="col-md-auto">
												<div class="mr-wd-6">
													...
													<a href="single-product-sidebar.html#" class="btn btn-sm btn-block btn-primary-dark btn-wide transition-3d-hover">Add all to cart</a>
												</div>
											</div>
										</div>
									</div>
									<div class="tab-pane fade" id="Jpills-two-example1" role="tabpanel" aria-labelledby="Jpills-two-example1-tab">
										...
										<ul class="nav flex-nowrap flex-xl-wrap overflow-auto overflow-xl-visble">
											...
											<li class="nav-item text-gray-111 flex-shrink-0 flex-xl-shrink-1"><strong>Category:</strong> <a href="single-product-sidebar.html#" class="text-blue">Headphones</a></li>
											<li class="nav-item text-gray-111 mx-3 flex-shrink-0 flex-xl-shrink-1">/</li>
											<li class="nav-item text-gray-111 flex-shrink-0 flex-xl-shrink-1"><strong>Tags:</strong> <a href="single-product-sidebar.html#" class="text-blue">Fast</a>, <a href="single-product-sidebar.html#" class="text-blue">Gaming</a>, <a href="single-product-sidebar.html#" class="text-blue">Strong</a></li>
										</ul>
									</div>
												...
												<form class="js-validate">
													<div class="row align-items-center mb-4">
														...
														<div class="col-md-8 col-lg-9">
															<a href="single-product-sidebar.html#" class="d-block">
				...
				<div class="mb-8">
					<div class="py-2 border-top border-bottom">
						<div class="js-slick-carousel u-slick my-1"
							...
							<div class="js-slide">
								<a href="single-product-sidebar.html#" class="link-hover__brand">
