	...
	<body>
		...
		<header id="header" class="u-header u-header-left-aligned-nav border-bottom border-color-1">
			<div class="u-header__section">
										...
										<div class="d-flex align-items-center">
											...
											<div class="position-relative">
												...
												<div id="languageDropdown" class="dropdown-menu dropdown-unfold" aria-labelledby="languageDropdownInvoker">
													<a class="dropdown-item active" href="home-v7.html#">English</a>
													<a class="dropdown-item" href="home-v7.html#">Deutsch</a>
													<a class="dropdown-item" href="home-v7.html#">Español‎</a>
												</div>
											</div>
											<!-- End Language -->
										</div>
						...
						<div class="row my-0dot5 my-xl-0 align-items-center position-relative">
							...
							<div class="col-auto">
								...
								<nav class="navbar navbar-expand u-header__navbar py-0">
									...
									<!-- Logo -->
									<a class="navbar-brand u-header__navbar-brand u-header__navbar-brand-center mr-0" href="index.php" aria-label="Electro">
															...
															<li class="u-has-submenu u-header-collapse__submenu">
																...
																<div id="headerSidebarPagesCollapse" class="collapse" data-parent="#headerSidebarContent">
																	<ul id="headerSidebarPagesMenu" class="u-header-collapse__nav-list">
																		<!-- Shop Grid -->
																		<li><a class="u-header-collapse__submenu-nav-link" href="shop-grid.php">Shop Grid</a></li>
																		<!-- End Shop Grid -->

																		<!-- Shop Grid Extended -->
																		<li><a class="u-header-collapse__submenu-nav-link" href="shop-grid-extended.php">Shop Grid Extended</a></li>
																		<!-- End Shop Grid Extended -->

																		<!-- Shop List View -->
																		<li><a class="u-header-collapse__submenu-nav-link" href="shop-list-view.php">Shop List View</a></li>
																		<!-- End Shop List View -->

																		<!-- Shop List View Small -->
																		<li><a class="u-header-collapse__submenu-nav-link" href="shop-list-view-small.php">Shop List View Small</a></li>
															...
															<li class="u-has-submenu u-header-collapse__submenu">
																...
																<div id="headerSidebarBlogCollapse" class="collapse" data-parent="#headerSidebarContent">
																	<ul id="headerSidebarBlogMenu" class="u-header-collapse__nav-list">
																		...
																		<!-- 5 Column Sidebar -->
																		<li><a class="u-header-collapse__submenu-nav-link" href="product-categories.php">5 Column Sidebar</a></li>
															...
															<li class="u-has-submenu u-header-collapse__submenu">
																...
																<div id="headerSidebarShopCollapse" class="collapse" data-parent="#headerSidebarContent">
																	<ul id="headerSidebarShopMenu" class="u-header-collapse__nav-list">
																		...
																		<li><a class="u-header-collapse__submenu-nav-link" href="single-product-extended.php">Single Product Extended</a></li>
																		<!-- End Single Product Extended -->

																		<!-- Single Product Sidebar -->
																		<li><a class="u-header-collapse__submenu-nav-link" href="single-product-sidebar.php">Single Product Sidebar</a></li>
															...
															<li class="u-has-submenu u-header-collapse__submenu">
																...
																<div id="headerSidebarDemosCollapse" class="collapse" data-parent="#headerSidebarContent">
																	<ul id="headerSidebarDemosMenu" class="u-header-collapse__nav-list">
																		<!-- Shop -->
																		<li><a class="u-header-collapse__submenu-nav-link" href="shop.php">Shop</a></li>
																		<!-- End Shop -->

																		<!-- Cart -->
																		<li><a class="u-header-collapse__submenu-nav-link" href="cart.php">Cart</a></li>
																		<!-- End Cart -->

																		<!-- Checkout -->
																		<li><a class="u-header-collapse__submenu-nav-link" href="checkout.php">Checkout</a></li>
																		<!-- End Checkout -->

																		<!-- My Account -->
																		<li><a class="u-header-collapse__submenu-nav-link" href="my-account.php">My Account</a></li>
																		<!-- End My Account -->

																		<!-- Track your Order -->
																		<li><a class="u-header-collapse__submenu-nav-link" href="track-your-order.php">Track your Order</a></li>
																		<!-- End Track your Order -->

																		<!-- Compare -->
																		<li><a class="u-header-collapse__submenu-nav-link" href="compare.php">Compare</a></li>
																		<!-- End Compare -->

																		<!-- wishlist -->
																		<li><a class="u-header-collapse__submenu-nav-link" href="wishlist.php">wishlist</a></li>
																		<!-- End wishlist -->
																	</ul>
																</div>
															</li>
															...
															<li class="u-has-submenu u-header-collapse__submenu">
																...
																<div id="headerSidebarblogsCollapse" class="collapse" data-parent="#headerSidebarContent">
																	<ul id="headerSidebarblogsMenu" class="u-header-collapse__nav-list">
																		...
																		<!-- Blog v3 -->
																		<li><a class="u-header-collapse__submenu-nav-link" href="blog.php">Blog</a></li>
																		<!-- End Blog v3 -->

																		<!-- Single Blog Post -->
																		<li><a class="u-header-collapse__submenu-nav-link" href="single-blog-post.php">Single Blog Post</a></li>
										...
										<div id="navBar" class="collapse navbar-collapse u-header__navbar-collapse">
											<ul class="navbar-nav u-header__navbar-nav">
												...
												<li class="nav-item u-header__nav-item">
													<a class="nav-link u-header__nav-link" href="index.php" aria-haspopup="true" aria-expanded="false" aria-labelledby="pagesSubMenu">Home</a>
												</li>
												<!-- End Home -->

												<!-- Featured Brands -->
												<li class="nav-item u-header__nav-item">
													<a class="nav-link u-header__nav-link" href="second-hand.php" aria-haspopup="true" aria-expanded="false" aria-labelledby="pagesSubMenu">Second Hand</a>
												</li>
												<!-- End Featured Brands -->

												<!-- Trending Styles -->
												<li class="nav-item u-header__nav-item">
													<a class="nav-link u-header__nav-link" href="shop.php" aria-haspopup="true" aria-expanded="false" aria-labelledby="blogSubMenu">Shop</a>
												</li>
												<!-- End Trending Styles -->
											</ul>
										</div>
							...
							<div class="col col-xl-auto text-right text-xl-left pl-0 pl-xl-3 position-static">
								<div class="d-inline-flex">
									<ul class="d-flex list-unstyled mb-0">
										...
										<!-- End Search -->
										<li class="col d-none d-xl-block"><a href="compare.php" class="text-gray-90" data-toggle="tooltip" data-placement="top" title="Compare"><i class="font-size-22 ec ec-compare"></i></a></li>
				...
				<?php
					if($page == 'second-hand.php') {
						include('banner-menu-second.php');
					}
				?>
