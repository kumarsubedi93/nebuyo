					...
					<table class="table">
						<tbody>
							<tr>
								...
								<td>
									<a href="compare.html#" class="product d-block">
								...
								<td>
									<a href="compare.html#" class="product">
										<div class="product-compare-image">
											<div class="d-flex mb-3">
							...
							<tr>
								<th>Add to cart</th>
								<td>
									<div class=""><a href="compare.html#" class="btn btn-soft-secondary mb-3 mb-md-0 font-weight-normal px-5 px-md-3 px-xl-5">Add to cart</a></div>
								</td>
								<td>
									<div class=""><a href="compare.html#" class="btn btn-soft-secondary mb-3 mb-md-0 font-weight-normal px-5 px-md-3 px-xl-5">Add to cart</a></div>
								</td>
							...
							<tr>
								...
								<td class="text-center">
									<a href="compare.html#" class="text-gray-90"><i class="fa fa-times"></i></a>
								</td>
								<td class="text-center">
									<a href="compare.html#" class="text-gray-90"><i class="fa fa-times"></i></a>
								</td>
