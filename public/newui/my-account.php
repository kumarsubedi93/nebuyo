					...
					<div class="row">
						<div class="col-md-5 ml-xl-auto mr-md-auto mr-xl-0 mb-8 mb-md-0">
							...
							<form class="js-validate" novalidate="novalidate">
								...
								<div class="mb-1">
									...
									<div class="mb-2">
										<a class="text-blue" href="my-account.html#">Lost your password?</a>
									</div>
								</div>
								<!-- End Button -->
							</form>
						...
						<div class="col-md-5 ml-md-auto ml-xl-0 mr-xl-auto">
							...
							<form class="js-validate" novalidate="novalidate">
								...
								<!-- End Form Group -->
								<p class="text-gray-90 mb-4">Your personal data will be used to support your experience throughout this website, to manage your account, and for other purposes described in our <a href="my-account.html#" class="text-blue">privacy policy.</a></p>
								<!-- Button -->
								<div class="mb-6">
									<div class="mb-3">
