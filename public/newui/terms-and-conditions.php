		...
		<main id="content" role="main">
			...
			<div class="container">
				...
				<div class="mb-10">
					...
					<p class="text-gray-90">If you have any questions about this Agreement, please contact us filling this <a href="contact.php" class="text-blue font-weight-bold">contact form</a></p>
				</div>
				<!-- Brand Carousel -->
				<div class="mb-8">
					<div class="py-2 border-top border-bottom">
						<div class="js-slick-carousel u-slick my-1"
							...
							<div class="js-slide">
								<a href="terms-and-conditions.html#" class="link-hover__brand">
