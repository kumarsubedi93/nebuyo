                    ...
                    <div class="d-none d-xl-block col-xl-3 col-wd-2gdot5">
                                ...
                                <li>
                                    ...
                                    <div id="sidebarNav1Collapse" class="collapse" data-parent="#sidebarNav">
                                        <ul id="sidebarNav1" class="list-unstyled dropdown-list">
                                            <!-- Menu List -->
                                            <li><a class="dropdown-item" href="shop-grid-extended.html#">Accessories<span class="text-gray-25 font-size-12 font-weight-normal"> (56)</span></a></li>
                                            <li><a class="dropdown-item" href="shop-grid-extended.html#">Cameras & Photography<span class="text-gray-25 font-size-12 font-weight-normal"> (11)</span></a></li>
                                            <li><a class="dropdown-item" href="shop-grid-extended.html#">Computer Components<span class="text-gray-25 font-size-12 font-weight-normal"> (22)</span></a></li>
                                            <li><a class="dropdown-item" href="shop-grid-extended.html#">Gadgets<span class="text-gray-25 font-size-12 font-weight-normal"> (5)</span></a></li>
                                            <li><a class="dropdown-item" href="shop-grid-extended.html#">Home Entertainment<span class="text-gray-25 font-size-12 font-weight-normal"> (7)</span></a></li>
                                            <li><a class="dropdown-item" href="shop-grid-extended.html#">Laptops & Computers<span class="text-gray-25 font-size-12 font-weight-normal"> (42)</span></a></li>
                                            <li><a class="dropdown-item" href="shop-grid-extended.html#">Printers & Ink<span class="text-gray-25 font-size-12 font-weight-normal"> (63)</span></a></li>
                                            <li><a class="dropdown-item" href="shop-grid-extended.html#">Smart Phones & Tablets<span class="text-gray-25 font-size-12 font-weight-normal"> (11)</span></a></li>
                                            <li><a class="dropdown-item" href="shop-grid-extended.html#">TV & Audio<span class="text-gray-25 font-size-12 font-weight-normal"> (66)</span></a></li>
                                            <li><a class="dropdown-item" href="shop-grid-extended.html#">Video Games & Consoles<span class="text-gray-25 font-size-12 font-weight-normal"> (31)</span></a></li>
                                            <!-- End Menu List -->
                                        </ul>
                                    </div>
                                </li>
                                <li>
                                    <a class="dropdown-current active" href="shop-grid-extended.html#">Smart Phones & Tablets <span class="text-gray-25 font-size-12 font-weight-normal"> (50)</span></a>

                                    <ul class="list-unstyled dropdown-list">
                                        <!-- Menu List -->
                                        <li><a class="dropdown-item" href="shop-grid-extended.html#">Smartphones<span class="text-gray-25 font-size-12 font-weight-normal"> (30)</span></a></li>
                                        <li><a class="dropdown-item" href="shop-grid-extended.html#">Tablets<span class="text-gray-25 font-size-12 font-weight-normal"> (20)</span></a></li>
                                        <!-- End Menu List -->
                                    </ul>
                                </li>
                            </ul>
                        ...
                        <div class="mb-6">
                            ...
                            <div class="border-bottom pb-4 mb-4">
                                ...
                                <!-- Link -->
                                <a class="link link-collapse small font-size-13 text-gray-27 d-inline-flex mt-2" data-toggle="collapse" href="shop-grid-extended.html#collapseBrand" role="button" aria-expanded="false" aria-controls="collapseBrand">
                            ...
                            <div class="border-bottom pb-4 mb-4">
                                ...
                                <!-- Link -->
                                <a class="link link-collapse small font-size-13 text-gray-27 d-inline-flex mt-2" data-toggle="collapse" href="shop-grid-extended.html#collapseColor" role="button" aria-expanded="false" aria-controls="collapseColor">
                                    <span class="link__icon text-gray-27 bg-white">
                                        <span class="link__icon-inner">+</span>
                                    </span>
                                    <span class="link-collapse__default">Show more</span>
                    ...
                    <div class="col-xl-9 col-wd-9gdot5">
                        ...
                        <div class="bg-gray-1 flex-center-between borders-radius-9 py-1">
                            ...
                            <div class="px-3 d-none d-xl-block">
                                <ul class="nav nav-tab-shop" id="pills-tab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link" id="pills-one-example1-tab" data-toggle="pill" href="shop-grid-extended.html#pills-one-example1" role="tab" aria-controls="pills-one-example1" aria-selected="false">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link active" id="pills-two-example1-tab" data-toggle="pill" href="shop-grid-extended.html#pills-two-example1" role="tab" aria-controls="pills-two-example1" aria-selected="false">
                                            <div class="d-md-flex justify-content-md-center align-items-md-center">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" id="pills-three-example1-tab" data-toggle="pill" href="shop-grid-extended.html#pills-three-example1" role="tab" aria-controls="pills-three-example1" aria-selected="true">
                                            <div class="d-md-flex justify-content-md-center align-items-md-center">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" id="pills-four-example1-tab" data-toggle="pill" href="shop-list-view-small.php#pills-four-example1" role="tab" aria-controls="pills-four-example1" aria-selected="true">
                                            <div class="d-md-flex justify-content-md-center align-items-md-center">
                            ...
                            <nav class="px-3 flex-horizontal-center text-gray-20 d-none d-xl-flex">
                                ...
                                <a class="text-gray-30 font-size-20 ml-2" href="shop-grid-extended.html#">→</a>
                            </nav>
                        </div>
                                        ...
                                        <div class="product-item__outer h-100">
                                            <div class="product-item__inner px-xl-4 p-3">
                                                <div class="product-item__body pb-xl-2">
                                                    ...
                                                    <div class="mb-3">
                                                        <a class="d-inline-flex align-items-center small font-size-14" href="shop-grid-extended.html#">
                        ...
                        <nav class="d-md-flex justify-content-between align-items-center border-top pt-3" aria-label="Page navigation example">
                            ...
                            <ul class="pagination mb-0 pagination-shop justify-content-center justify-content-md-start">
                                <li class="page-item"><a class="page-link current" href="shop-grid-extended.html#">1</a></li>
                                <li class="page-item"><a class="page-link" href="shop-grid-extended.html#">2</a></li>
                                <li class="page-item"><a class="page-link" href="shop-grid-extended.html#">3</a></li>
                            </ul>
                        </nav>
                        <!-- End Shop Pagination -->
                    </div>
                ...
                <div class="mb-6">
                    <div class="py-2 border-top border-bottom">
                        <div class="js-slick-carousel u-slick my-1"
                            ...
                            <div class="js-slide">
                                <a href="shop-grid-extended.html#" class="link-hover__brand">
