			...
			<div class="pt-8 pb-4 bg-gray-13">
				<div class="container mt-1">
					<div class="row">
						<div class="col-lg-5">
							<div class="mb-6">
								<a href="home-v7.html#" class="d-inline-block">
							...
							<div class="my-4 my-md-4">
								<ul class="list-inline mb-0 opacity-7">
									<li class="list-inline-item mr-0">
										<a class="btn font-size-20 btn-icon btn-soft-dark btn-bg-transparent rounded-circle" href="home-v7.html#">
							...
							<div class="row">
								<div class="col-12 col-md mb-4 mb-md-0">
									...
									<ul class="list-group list-group-flush list-group-borderless mb-0 list-group-transparent">
										<li><a class="list-group-item list-group-item-action" href="product-categories.php">Laptops & Computers</a></li>
										<li><a class="list-group-item list-group-item-action" href="product-categories.php">Cameras & Photography</a></li>
										<li><a class="list-group-item list-group-item-action" href="product-categories.php">Smart Phones & Tablets</a></li>
										<li><a class="list-group-item list-group-item-action" href="product-categories.php">Video Games & Consoles</a></li>
										<li><a class="list-group-item list-group-item-action" href="product-categories.php">TV & Audio</a></li>
										<li><a class="list-group-item list-group-item-action" href="product-categories.php">Gadgets</a></li>
										<li><a class="list-group-item list-group-item-action" href="product-categories.php">Car Electronic & GPS</a></li>
									</ul>
									<!-- End List Group -->
								</div>
								...
								<div class="col-12 col-md mb-4 mb-md-0">
									...
									<ul class="list-group list-group-flush list-group-borderless mb-0 list-group-transparent mt-md-6">
										<li><a class="list-group-item list-group-item-action" href="product-categories.php">Printers & Ink</a></li>
										<li><a class="list-group-item list-group-item-action" href="product-categories.php">Software</a></li>
										<li><a class="list-group-item list-group-item-action" href="product-categories.php">Office Supplies</a></li>
										<li><a class="list-group-item list-group-item-action" href="product-categories.php">Computer Components</a></li>
										<li><a class="list-group-item list-group-item-action" href="product-categories.php">Accesories</a></li>
									</ul>
									<!-- End List Group -->
								</div>
								...
								<div class="col-12 col-md mb-4 mb-md-0">
									...
									<ul class="list-group list-group-flush list-group-borderless mb-0 list-group-transparent">
										...
										<li><a class="list-group-item list-group-item-action" href="terms-and-conditions.php">Terms and Conditions</a></li>
									</ul>
									<!-- End List Group -->
								</div>
							</div>
			...
			<div class="bg-gray-14 py-2">
				<div class="container">
					<div class="flex-center-between d-block d-md-flex">
						<div class="mb-3 mb-md-0">© <a href="home-v7.html#" class="font-weight-bold text-gray-90">Electro</a> - All rights Reserved</div>
							...
							<div class="u-sidebar__content u-header-sidebar__content">
								<form class="js-validate">
									...
									<div id="login" data-target-group="idForm">
										...
										<!-- Login Buttons -->
										<div class="d-flex">
											<a class="btn btn-block btn-sm btn-soft-facebook transition-3d-hover mr-1" href="home-v7.html#">
											  <span class="fab fa-facebook-square mr-1"></span>
											  Facebook
											</a>
											<a class="btn btn-block btn-sm btn-soft-google transition-3d-hover ml-1 mt-0" href="home-v7.html#">
		...
		<!-- Go to Top -->
		<a class="js-go-to u-go-to" href="home-v7.html#"
