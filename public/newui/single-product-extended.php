                ...
                <div class="mb-14">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-4 mb-md-6 mb-lg-0">
                            <div class="mb-2">
                                <a href="single-product-extended.html#" class="font-size-12 text-gray-5 mb-2 d-inline-block">Headphones</a>
                                <h2 class="font-size-25 text-lh-1dot2">Ultra Wireless S50 Headphones S50 with Bluetooth</h2>
                                <div class="mb-2">
                                    <a class="d-inline-flex align-items-center small font-size-15 text-lh-1" href="single-product-extended.html#">
                                ...
                                <a href="single-product-extended.html#" class="d-inline-block max-width-150 ml-n2 mb-2"><img class="img-fluid" src="assets/img/200X60/img1.png" alt="Image Description"></a>
                                <div class="mb-2">
                            ...
                            <div class="mb-2">
                                <div class="card p-5 border-width-2 border-color-1 borders-radius-17">
                                    ...
                                    <div class="mb-2 pb-0dot5">
                                        <a href="single-product-extended.html#" class="btn btn-block btn-primary-dark"><i class="ec ec-add-to-cart mr-2 font-size-20"></i> Add to Cart</a>
                                    </div>
                                    <div class="mb-3">
                                        <a href="single-product-extended.php" class="btn btn-block btn-dark">Buy Now</a>
                                    </div>
                                    <div class="flex-content-center flex-wrap">
                                        <a href="single-product-extended.html#" class="text-gray-6 font-size-13 mr-2"><i class="ec ec-favorites mr-1 font-size-15"></i> Wishlist</a>
                                        <a href="single-product-extended.html#" class="text-gray-6 font-size-13 ml-2"><i class="ec ec-compare mr-1 font-size-15"></i> Compare</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="position-relative mb-6">
                                    <ul class="nav nav-classic nav-tab nav-tab-lg justify-content-xl-center flex-nowrap flex-xl-wrap overflow-auto overflow-xl-visble border-lg-down-bottom-0 pb-1 pb-xl-0 mb-n1 mb-xl-0">
                                        <li class="nav-item flex-shrink-0 flex-xl-shrink-1 z-index-2">
                                            <a class="nav-link active" href="single-product-extended.html#Accessories">
                                        ...
                                        <li class="nav-item flex-shrink-0 flex-xl-shrink-1 z-index-2">
                                            <a class="nav-link" href="single-product-extended.html#Description">
                                                <div class="d-md-flex justify-content-md-center align-items-md-center">
                                                    Description
                                                </div>
                                            </a>
                                        ...
                                        <li class="nav-item flex-shrink-0 flex-xl-shrink-1 z-index-2">
                                            <a class="nav-link" href="single-product-extended.html#Specification">
                                                <div class="d-md-flex justify-content-md-center align-items-md-center">
                                                    Specification
                                                </div>
                                            </a>
                                        ...
                                        <li class="nav-item flex-shrink-0 flex-xl-shrink-1 z-index-2">
                                            <a class="nav-link" href="single-product-extended.html#Reviews">
                                                <div class="d-md-flex justify-content-md-center align-items-md-center">
                                                    Reviews
                                                </div>
                                            </a>
                                    ...
                                    <div class="row no-gutters">
                                                    ...
                                                    <div class="product-item__outer h-100">
                                                        <div class="remove-prodcut-hover product-item__inner px-xl-4 p-3">
                                                            <div class="product-item__body pb-xl-2">
                                                                ...
                                                                <h5 class="mb-1 product-item__title d-none d-md-block"><a href="single-product-extended.html#" class="text-blue font-weight-bold">Wireless Audio System Multiroom 360 degree Full base audio</a></h5>
                                                                <div class="mb-2">
                                                ...
                                                <li class="col-4 col-md-4 col-xl-2gdot5 product-item remove-divider-sm-down">
                                                    <div class="product-item__outer h-100">
                                                        <div class="remove-prodcut-hover add-accessories product-item__inner px-xl-4 p-3">
                                                            <div class="product-item__body pb-xl-2">
                                                                <div class="mb-2 d-none d-md-block"><a href="product-categories-7-column-full-width.html" class="font-size-12 text-gray-5">Speakers</a></div>
                                                                <h5 class="mb-1 product-item__title d-none d-md-block"><a href="single-product-extended.html#" class="text-blue font-weight-bold">Tablet White EliteBook Revolve 810 G2</a></h5>
                                                                <div class="mb-2">
                                                ...
                                                <li class="col-4 col-md-4 col-xl-2gdot5 product-item remove-divider-sm-down remove-divider">
                                                    <div class="product-item__outer h-100">
                                                        <div class="remove-prodcut-hover add-accessories product-item__inner px-xl-4 p-3">
                                                            <div class="product-item__body pb-xl-2">
                                                                <div class="mb-2 d-none d-md-block"><a href="product-categories-7-column-full-width.html" class="font-size-12 text-gray-5">Speakers</a></div>
                                                                <h5 class="mb-1 product-item__title d-none d-md-block"><a href="single-product-extended.html#" class="text-blue font-weight-bold">Purple Solo 2 Wireless</a></h5>
                                                                <div class="mb-2">
                                        ...
                                        <div class="col-md-auto">
                                            <div class="mr-xl-15">
                                                ...
                                                <a href="single-product-extended.html#" class="btn btn-sm btn-block btn-primary-dark btn-wide transition-3d-hover">Add all to cart</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div id="Description" class="mx-md-2">
                                <div class="position-relative mb-6">
                                    <ul class="nav nav-classic nav-tab nav-tab-lg justify-content-xl-center mb-6 flex-nowrap flex-xl-wrap overflow-auto overflow-xl-visble border-lg-down-bottom-0 pb-1 pb-xl-0 mb-n1 mb-xl-0">
                                        <li class="nav-item flex-shrink-0 flex-xl-shrink-1 z-index-2">
                                            <a class="nav-link" href="single-product-extended.html#Accessories">
                                                <div class="d-md-flex justify-content-md-center align-items-md-center">
                                                    Accessories
                                                </div>
                                            </a>
                                        ...
                                        <li class="nav-item flex-shrink-0 flex-xl-shrink-1 z-index-2">
                                            <a class="nav-link active" href="single-product-extended.html#Description">
                                                <div class="d-md-flex justify-content-md-center align-items-md-center">
                                                    Description
                                                </div>
                                            </a>
                                ...
                                <div class="mx-md-4 pt-1">
                                    ...
                                    <ul class="nav flex-nowrap flex-xl-wrap overflow-auto overflow-xl-visble">
                                        ...
                                        <li class="nav-item text-gray-111 flex-shrink-0 flex-xl-shrink-1"><strong>Category:</strong> <a href="single-product-extended.html#" class="text-blue">Headphones</a></li>
                                        <li class="nav-item text-gray-111 mx-3 flex-shrink-0 flex-xl-shrink-1">/</li>
                                        <li class="nav-item text-gray-111 flex-shrink-0 flex-xl-shrink-1"><strong>Tags:</strong> <a href="single-product-extended.html#" class="text-blue">Fast</a>, <a href="single-product-extended.html#" class="text-blue">Gaming</a>, <a href="single-product-extended.html#" class="text-blue">Strong</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                            ...
                            <div id="Specification" class="mx-md-2">
                                <div class="position-relative mb-6">
                                    <ul class="nav nav-classic nav-tab nav-tab-lg justify-content-xl-center mb-6 flex-nowrap flex-xl-wrap overflow-auto overflow-xl-visble border-lg-down-bottom-0 pb-1 pb-xl-0 mb-n1 mb-xl-0">
                                        ...
                                        <li class="nav-item flex-shrink-0 flex-xl-shrink-1 z-index-2">
                                            <a class="nav-link active" href="single-product-extended.html#Specification">
                                                <div class="d-md-flex justify-content-md-center align-items-md-center">
                                                    Specification
                                                </div>
                                            </a>
                            ...
                            <div id="Reviews" class="mx-md-2">
                                <div class="position-relative mb-6">
                                    <ul class="nav nav-classic nav-tab nav-tab-lg justify-content-xl-center mb-6 flex-nowrap flex-xl-wrap overflow-auto overflow-xl-visble border-lg-down-bottom-0 pb-1 pb-xl-0 mb-n1 mb-xl-0">
                                        ...
                                        <li class="nav-item flex-shrink-0 flex-xl-shrink-1 z-index-2">
                                            <a class="nav-link active" href="single-product-extended.html#Reviews">
                                                <div class="d-md-flex justify-content-md-center align-items-md-center">
                                                    Reviews
                                                </div>
                                            </a>
                ...
                <div class="mb-8">
                    <div class="py-2 border-top border-bottom">
                        <div class="js-slick-carousel u-slick my-1"
                            ...
                            <div class="js-slide">
                                <a href="single-product-extended.html#" class="link-hover__brand">
