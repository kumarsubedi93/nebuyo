				...
				<div id="shopCartAccordion" class="accordion rounded mb-5">
					...
					<div class="card border-0">
						<div id="shopCartHeadingOne" class="alert alert-primary mb-0" role="alert">
							Returning customer? <a href="my-account.php" class="alert-link" data-toggle="collapse" data-target="#shopCartOne" aria-expanded="false" aria-controls="shopCartOne">Click here to login</a>
						</div>
						<div id="shopCartOne" class="collapse border border-top-0" aria-labelledby="shopCartHeadingOne" data-parent="#shopCartAccordion" style="">
							...
							<form class="js-validate p-5">
								...
								<div class="mb-1">
									...
									<div class="mb-2">
										<a class="text-blue" href="checkout.html#">Lost your password?</a>
									</div>
								</div>
								<!-- End Button -->
							</form>
				...
				<div id="shopCartAccordion1" class="accordion rounded mb-6">
					...
					<div class="card border-0">
						<div id="shopCartHeadingTwo" class="alert alert-primary mb-0" role="alert">
							Have a coupon? <a href="checkout.html#" class="alert-link" data-toggle="collapse" data-target="#shopCartTwo" aria-expanded="false" aria-controls="shopCartTwo">Click here to enter your code</a>
						</div>
													...
													<div class="p-3" id="basicsHeadingFour">
														<div class="custom-control custom-radio">
															...
															<label class="custom-control-label form-label" for="FourstylishRadio1"
																...
																PayPal <a href="checkout.html#" class="text-blue">What is PayPal?</a>
															</label>
														</div>
													</div>
										...
										<div class="form-group d-flex align-items-center justify-content-between px-3 mb-5">
											<div class="form-check">
												...
												<label class="form-check-label form-label" for="defaultCheck10">
													I have read and agree to the website <a href="checkout.html#" class="text-blue">terms and conditions </a>
