...
class CategoryController extends BaseController
{
    ...
    public function store(Request $request)
    {
        ...
        $category->saveFields($request->get('attribute_field'));
    ...
    public function edit($id)
    {
        ...
        $data['attributes'] = $category->fields;
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->get('attribute_field')) {
            $category->updateFields($request->get('attribute_field'));
        } else {
    ...
    public function getSpecification(Request $request)
    {
        ...
        $data['attributes'] = $this->fieldService->byCategory($category_id, $category_type);

        if($data['attributes']->isNotEmpty()) {
            $data['html'] = view('common.category-specification-form', compact('data'))->render();
        }
        else {
            $data['html'] = null;
        }
