...
class NewCheckoutController extends Controller
{
    ...
    {
        if($this->checkProductAvailable() != true){
            return $this->checkProductAvailable();
        }
        ...
        if ($request->payment_option != null) {
            ...
            if ($request->session()->get('order_id') != null) {
                if ($request->payment_option == 'paypal') {
                    ...
                    return redirect()->route('new.order_confirmed');
    ...
    public function checkout_done($order_id, $payment)
    {
        ...
        return view('newui.order_confirmed', compact('order'));
    }
    ...
    public function get_shipping_info(Request $request)
    {
        if (Session::has('cart') && count(Session::get('cart')) > 0) {
            ...
            return view('newui.shipping_info', compact('categories'));
        }
    ...
    public function store_shipping_info(Request $request)
    {
        ...
        return view('newui.delivery_info');
    ...
    public function store_delivery_info(Request $request)
    {
        if (Session::has('cart') && count(Session::get('cart')) > 0) {
            ...
            return view('newui.payment_select', compact('total'));
        } else {
    ...
    public function checkProductAvailable()
    {
        ...
        if(count($productName) ){
            return redirect()->route('new.cart')->with(['msgCartError' => $productName]);
        }else{
            return true;
        }
    }
